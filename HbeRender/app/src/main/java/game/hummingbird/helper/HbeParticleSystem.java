...
public class HbeParticleSystem implements Cloneable {
    ...
    public HbeParticleSystem(String filename, HbeSprite sprite) {
        ...
        info.nEmission = _lBytesToInt(bit4);
        pos += 4;

        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fLifetime = _lBytesToFloat(bit4);
        pos += 4;

        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fParticleLifeMin = _lBytesToFloat(bit4);
        pos += 4;

        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fParticleLifeMax = _lBytesToFloat(bit4);
        pos += 4;

        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fDirection = _lBytesToFloat(bit4);
        pos += 4;

        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpread = _lBytesToFloat(bit4);
        pos += 4;
        ...
        // speed
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpeedMin = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpeedMax = _lBytesToFloat(bit4);
        pos += 4;

        // gravity
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fGravityMin = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fGravityMax = _lBytesToFloat(bit4);
        pos += 4;

        // radial accel
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fRadialAccelMin = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fRadialAccelMax = _lBytesToFloat(bit4);
        pos += 4;

        // tangential accel
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fTangentialAccelMin = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fTangentialAccelMax = _lBytesToFloat(bit4);
        pos += 4;

        // size
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSizeStart = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSizeEnd = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSizeVar = _lBytesToFloat(bit4);
        pos += 4;

        // spin
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpinStart = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpinEnd = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fSpinVar = _lBytesToFloat(bit4);
        pos += 4;

        // color start
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorStart.r = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorStart.g = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorStart.b = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorStart.a = _lBytesToFloat(bit4);
        pos += 4;

        // color end
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorEnd.r = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorEnd.g = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorEnd.b = _lBytesToFloat(bit4);
        pos += 4;
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.colColorEnd.a = _lBytesToFloat(bit4);
        pos += 4;

        // color var
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fColorVar = _lBytesToFloat(bit4);
        pos += 4;

        // alpha var
        System.arraycopy(buf, pos, bit4, 0, 4);
        info.fAlphaVar = _lBytesToFloat(bit4);
        pos += 4;
        ////////////////////////////////////
        ...
        if(_fAge != -2.0f)
        {
            ...
            for(i=0; i<nParticlesCreated; i++)
            {
                ...
                else//reverse particle
                {
                    ...
                    par.fTerminalAge = (-par.vecVelocity.x+
                            (float)(Math.sqrt(par.vecVelocity.x*par.vecVelocity.x+2.0f*par.fRadialAccel*length)))
                            /par.fRadialAccel;
                    par.fGravity = 0.0f;
    ...
    private static float _lBytesToFloat(byte[] b) {
        int i = 0;
    ...
    private static int _lBytesToInt(byte[] b) {
        int s = 0;
        for (int i = 0; i < 3; i++) {
            if (b[3 - i] >= 0) {
                s = s + b[3 - i];
